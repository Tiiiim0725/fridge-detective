...
function RootNavigator() {
  ...
  const shouldRedirectToOnboarding = !isBootstrapping
    ...
    && !isDevRoute
    && !isOnboardingRoute
  const showProfileButton = !isBootstrapping
      ...
      <View style={[styles.root, Platform.OS === 'web' && styles.webRoot]}>
        <View style={[styles.appViewport, Platform.OS === 'web' && styles.webViewport]}>
          <Stack>
            ...
            <Stack.Screen name="recipe/[recipeKey]" options={{ headerShown: false }} />
            <Stack.Screen name="recipe/[recipeKey]/cook" options={{ headerShown: false }} />
            <Stack.Screen name="modal" options={{ presentation: 'modal', title: 'Modal' }} />
          </Stack>

          {showProfileButton ? (
            <FloatingProfileButton style={styles.globalProfileButton} />
          ) : null}
